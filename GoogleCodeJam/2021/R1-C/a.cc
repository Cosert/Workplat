const int TYP=
1
; inline void putcas(int casnum, char eol); inline void solvetp(int typ, int T); 
#include<bits/stdc++.h>
...
inline void putcas(int casnum, char eol) { pstr("Case #", 0); wo(casnum); putchar(':'); putchar(eol); } 
