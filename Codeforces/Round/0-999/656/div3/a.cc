...
inline void solve() { 
    ...
    if(li[1]!=li[2] && li[2]!=li[3]) pstr("NO", 1); 
    else if(li[1]==li[2] && li[2]==li[3]) { 
        pstr("YES", 1); 
        rep(i, 3) wo(li[1], 2); 
        putchar('\n'); 
    } 
    else if(li[1]==li[2]) pstr("NO", 1); 
    else { 
        pstr("YES", 1); 
        if(m[1]!=li[3]) wo(li[1], 2), wo(li[1], 2),wo(li[2]); 
        if(m[2]!=li[3]) wo(li[1], 2), wo(li[2], 2),wo(li[1]); 
        if(m[3]!=li[3]) wo(li[2], 2), wo(li[1], 2),wo(li[1]); 
    } 
} 
